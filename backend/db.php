...
class DB
{
    ...
    private $intezmeny_procedures = '
        ...
        CREATE OR REPLACE PROCEDURE newClass (
        ...
        CREATE OR REPLACE PROCEDURE getClassByName (
        IN in_name VARCHAR(200)
         )
        
        BEGIN
        
        SELECT * FROM class WHERE name=in_name;
        
        END;
        
        CREATE OR REPLACE PROCEDURE getClassById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM class WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modClass (
        IN in_id INT UNSIGNED,
        IN in_name VARCHAR(200),
        IN in_headcount SMALLINT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newGroup_ (
        IN in_name VARCHAR(200),
        IN in_headcount SMALLINT UNSIGNED,
        ...
        CREATE OR REPLACE PROCEDURE getGroup_ByName (
        IN in_name VARCHAR(200)
         )
        
        BEGIN
        
        SELECT * FROM group_ WHERE name=in_name;
        
        END;
        
        CREATE OR REPLACE PROCEDURE getGroup_ById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM group_ WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modGroup_ (
        IN in_id INT UNSIGNED,
        IN in_name VARCHAR(200),
        IN in_headcount SMALLINT UNSIGNED,
        IN in_class_id INT UNSIGNED
        ...
        CREATE OR REPLACE PROCEDURE delGroup_ (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newLesson (
        IN in_name VARCHAR(200)
        )
        ...
        CREATE OR REPLACE PROCEDURE getLessonByName (
        IN in_name VARCHAR(200)
         )
        
        BEGIN
        
        SELECT * FROM lesson WHERE name=in_name;
        
        END;
        
        CREATE OR REPLACE PROCEDURE getLessonById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM lesson WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modLesson (
        IN in_id INT UNSIGNED,
        IN in_name VARCHAR(200)
        )
        ...
        CREATE OR REPLACE PROCEDURE delLesson (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newRoom (
        IN in_name VARCHAR(200),
        ...
        CREATE OR REPLACE PROCEDURE getRoomByName (
        IN in_name VARCHAR(200)
         )
        
        BEGIN
        
        SELECT * FROM room WHERE name=in_name;
        
        END;
        
        CREATE OR REPLACE PROCEDURE getRoomById (
        IN in_id INT UNSIGNED
         )
        ...
        CREATE OR REPLACE PROCEDURE modRoom (
        IN in_id INT UNSIGNED,
        IN in_name VARCHAR(200),
        IN in_room_type VARCHAR(200),
        IN in_space INT UNSIGNED
        ...
        CREATE OR REPLACE PROCEDURE delRoom (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newTeacher (
        IN in_name VARCHAR(200),
        ...
        CREATE OR REPLACE PROCEDURE getTeacherByName (
        IN in_name VARCHAR(200)
         )
        
        BEGIN
        
        SELECT * FROM teacher WHERE name=in_name;
        
        END;
        
        CREATE OR REPLACE PROCEDURE getTeacherById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM teacher WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modTeacher (
        IN in_id INT UNSIGNED,
        IN in_name VARCHAR(200),
        IN in_job VARCHAR(200),
        IN in_email VARCHAR(254),
        ...
        CREATE OR REPLACE PROCEDURE delTeacher (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newTeacher_lesson (
        ...
        CREATE OR REPLACE PROCEDURE getTeacher_lessonById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM teacher_lesson WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modTeacher_lesson (
        IN in_id INT UNSIGNED,
        IN in_teacher_id INT UNSIGNED,
        IN in_lesson_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE delTeacher_lesson (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newTeacher_availability (
        IN in_teacher_id INT UNSIGNED,
        ...
        CREATE OR REPLACE PROCEDURE getTeacher_availabilityById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM teacher_availability WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modTeacher_availability (
        IN in_id INT UNSIGNED,
        IN in_teacher_id INT UNSIGNED,
        IN in_available_from_day TINYINT UNSIGNED,
        IN in_available_from_time TIME,
        ...
        CREATE OR REPLACE PROCEDURE delTeacher_availability (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newTimetable (
        IN in_duration TIME,
        ...
        CREATE OR REPLACE PROCEDURE getTimetableById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM timetable WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modTimetable (
        IN in_id INT UNSIGNED,
        IN in_duration TIME,
        IN in_group_id INT UNSIGNED,
        IN in_lesson_id INT UNSIGNED,
        ...
        CREATE OR REPLACE PROCEDURE delTimetable (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newHomework (
        IN in_due DATETIME,
        IN in_lesson_id INT UNSIGNED,
        IN in_teacher_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE getHomeworkById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM homework WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modHomework (
        IN in_id INT UNSIGNED,
        IN in_due DATETIME,
        IN in_lesson_id INT UNSIGNED,
        IN in_teacher_id INT UNSIGNED
        ...
        CREATE OR REPLACE PROCEDURE delHomework (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newAttachments (
        ...
        CREATE OR REPLACE PROCEDURE getAttachmentsById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM attachments WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modAttachments (
        IN in_id INT UNSIGNED,
        IN in_file_name VARCHAR(255)
        )
        ...
        CREATE OR REPLACE PROCEDURE delAttachments (
        IN in_id INT UNSIGNED
        )
        ...
        CREATE OR REPLACE PROCEDURE newHomework_attachments (
        ...
        CREATE OR REPLACE PROCEDURE getHomework_attachmentsById (
        IN in_id INT UNSIGNED
         )
        
        BEGIN
        
        SELECT * FROM homework_attachments WHERE id=in_id;
        
        END;
        
        CREATE OR REPLACE PROCEDURE modHomework_attachments (
        IN in_id INT UNSIGNED,
        IN in_homework_id INT UNSIGNED,
        IN in_attachments_id INT UNSIGNED
        )
        ...
        UPDATE homework_attachments SET
        ...
        CREATE OR REPLACE PROCEDURE delHomework_attachments (
        IN in_id INT UNSIGNED
        )
